...
export class PaymentNotificationService {
  ...
  private async sendEmailNotification(template: NotificationTemplate, variables: Record<string, string>): Promise<void> {
    // Email notification implementation
    console.log('Email notification sent:', template.subject)
  }

  private async sendSMSNotification(template: NotificationTemplate, variables: Record<string, string>): Promise<void> {
    // SMS notification implementation
    console.log('SMS notification sent:', template.body)
  }

  private async sendPushNotification(template: NotificationTemplate, variables: Record<string, string>): Promise<void> {
    // Push notification implementation
    console.log('Push notification sent:', template.subject)
  }

  private async sendWebhookNotification(eventType: string, variables: Record<string, string>): Promise<void> {
